    ...
    public function display_field($data = array(), $post = null, $echo = true)
    {
        ...
        switch ($field['type']) {
            ...
            case 'email':
                ...
                break;
            case 'text_readonly':
                $html .= '<input readonly id="'.esc_attr($field['id']).'" type="text" name="'.esc_attr($option_name).'" placeholder="'.esc_attr($field['placeholder']).'" value="'.esc_attr($data).'" />'."\n";
                break;
            ...
            case 'image':
                ...
                $html .= '<input id="'.$option_name.'_button" type="button" data-uploader_title="'.__('Upload an image', 'apollo').'" data-uploader_button_text="'.__('Use image', 'apollo').'" class="image_upload_button button" value="'.__('Upload new image', 'apollo').'" />'."\n";
                $html .= '<input id="'.$option_name.'_delete" type="button" class="image_delete_button button" value="'.__('Remove image', 'apollo').'" />'."\n";
