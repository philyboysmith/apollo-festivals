...
Installing "Apollo" can be done either by searching for "Apollo" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
